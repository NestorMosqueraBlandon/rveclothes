                ...
                <Select value={rating} onChange={ratingHandler} fullWidth>
                  ...
                  {ratings.map((rating) => (
                    <MenuItem dispaly="flex" key={rating} value={rating}>
                      ...
                      <Typography component="span">&amp; Mayores</Typography>
                    </MenuItem>
                  ))}
                </Select>
              </Box>
          ...
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                ...
                <MenuItem value="lowest">Precio: Mas bajo</MenuItem>
                <MenuItem value="highest">Precio: Mas alto</MenuItem>
                <MenuItem value="toprated">Resenas de clientes</MenuItem>
                <MenuItem value="newest">Nueva Coleccion</MenuItem>
              </Select>
            </Grid>
          </Grid>
